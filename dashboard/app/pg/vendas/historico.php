...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Histórico de vendas</h3>
    </div>
</div>
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from fatura WHERE id LIKE '%$busca%' AND estado = 1";
										$select.= " OR id_factura LIKE '%$busca%' AND estado = 1 ORDER BY id DESC";
									else:
										$select = 'SELECT * from fatura WHERE estado = 1 ORDER BY id DESC';
									endif;
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="historico-id">
											<label class="custom-control-label" for="historico-id"></label>
										</div>'
										);
										...
										?>
										<tr <?php if($mostra->entrega == 0): echo 'class="table-danger"'; endif; ?>>
											<th scope="row"><?php echo $mostra->id; ?></th>
                                            <td><?php echo $mostra->id_factura; ?></td>
                                            <td><?php echo $mostra->nome_do_cliente; ?></td>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														historico-select="<?php echo $mostra->id; ?>"
														id="historico-<?php echo $mostra->id; ?>">
														
														<label 
														class="custom-control-label" 
														for="historico-<?php echo $mostra->id; ?>"></label>
													</div>

                                                    <i class="las la-info-circle"
                                                    data-toggle="modal" data-target="#visualizar-fatura<?php echo $mostra->id; ?>"
...
<!-- /Visualizar factura -->
										...
										$paginacao->queryString = 'historico';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?historico";</script>';
											exit(); 
										endif;
...
<script src="assets/js/vendas/historico.js"></script>