...
<div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<blockquote>
                    <h2 class="m-2">Termos de serviços & privacidade</h2>
                </blockquote>

				<p>A sua privacidade é importante para nós. É política da CivilPro Lda, respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="./">CivilPro, Lda</a>. e outros sites que possuímos e operamos.</p>
				...
				<p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a href='javascript:void(0)'>políticas de privacidade</a>.</p>                    
